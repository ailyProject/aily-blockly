export default (() => {
	...
	return async function (moduleArg = {}) {
		...
		function assignWasmExports(wasmExports) {
			_lfs_wasm_set_disk_version = Module['_lfs_wasm_set_disk_version'] = wasmExports['j']
			_lfs_wasm_get_disk_version = Module['_lfs_wasm_get_disk_version'] = wasmExports['k']
			_lfs_wasm_init = Module['_lfs_wasm_init'] = wasmExports['l']
			_free = Module['_free'] = wasmExports['m']
			_malloc = Module['_malloc'] = wasmExports['n']
			_lfs_wasm_init_from_image = Module['_lfs_wasm_init_from_image'] = wasmExports['o']
			_lfs_wasm_get_fs_info = Module['_lfs_wasm_get_fs_info'] = wasmExports['p']
			...
			_lfs_wasm_get_image_size = Module['_lfs_wasm_get_image_size'] = wasmExports['E']
