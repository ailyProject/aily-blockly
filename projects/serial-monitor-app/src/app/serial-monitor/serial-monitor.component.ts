...
import { SerialMonitorService, dataItem } from '../services/serial-monitor.service';
import { UiScrollModule, Datasource, SizeStrategy } from 'ngx-ui-scroll';
import { HistoryMessageListComponent } from './history-message-list/history-message-list.component';
import { QuickSendListComponent } from './quick-send-list/quick-send-list.component';
import { BAUDRATE_LIST } from './config';
import { SettingMoreComponent } from './setting-more/setting-more.component';
import { QuickSendEditorComponent } from './quick-send-editor/quick-send-editor.component';
